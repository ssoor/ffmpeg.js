...
self.onmessage = function (e) {
  ...
  if (msg["type"] == "run") {
    if (__ffmpegjs_running) {
      ...
      self.postMessage({ "type": "start", 'data': msg.arguments.join(" ") });
      ...
      self.postMessage({
        ...
        'data': 'Received command: ' +
          opts.arguments.join(" ") +
          ((opts.TOTAL_MEMORY) ? ".  Processing with " + opts.TOTAL_MEMORY + " bits." : "")
      });
      ...
      var transfer = result["files"].map(function (file) {
